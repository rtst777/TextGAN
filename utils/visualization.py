...
if __name__ == '__main__':
    ...
    log_file_list = ['log_0604_2233', 'log_0605_0120', 'log_0531_1507'] # TODO(ethanjiang) add log for 'GumbelGAN', 'RebarGAN', and 'RelbarGAN'
    legend_text = ['SeqGAN', 'LeakGAN', 'RelGAN'] # TODO(ethanjiang) add 'GumbelGAN', 'RebarGAN', and 'RelbarGAN'
