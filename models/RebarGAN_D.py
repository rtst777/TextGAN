...
class RebarGAN_D(CNNDiscriminator):
    '''The discriminator from RebarGAN.'''
    ...
    def __init__(self, embed_dim, max_seq_len, num_rep, vocab_size, padding_idx, gpu=False, dropout=0.25):
        ...
        super(RebarGAN_D, self).__init__(embed_dim, vocab_size, dis_filter_sizes, dis_num_filters, padding_idx,
                                          gpu, dropout)
...
class RebarGAN_D2(CNNDiscriminator):
    ...
    def __init__(self, embed_dim, max_seq_len, vocab_size, padding_idx, gpu=False, dropout=0.25):
        ...
        super(RebarGAN_D2, self).__init__(embed_dim, vocab_size, dis_filter_sizes, dis_num_filters, padding_idx,
                                           gpu, dropout)
